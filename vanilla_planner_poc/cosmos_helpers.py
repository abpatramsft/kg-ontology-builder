"""
cosmos_helpers.py — Azure Cosmos DB Gremlin connection & query helpers.

All graph operations target the Cosmos DB Gremlin API
(database: indigokg, container: knowledgegraph).
"""
